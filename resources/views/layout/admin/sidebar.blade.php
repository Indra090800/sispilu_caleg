          ...
          <div class="collapse navbar-collapse" id="sidebar-menu">
            <ul class="navbar-nav pt-lg-3">
              ...
              <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle {{ request()->is(['caleg', 'parpol','saksi','role','voters']) ? 'show' : '' }}"  href="#navbar-base" data-bs-toggle="dropdown" data-bs-auto-close="false" role="button" aria-expanded="{{ request()->is(['caleg', 'parpol','saksi','role','voters']) ? 'true' : '' }}" >
                ...
                <li class="nav-item">
                  <a class="nav-link {{ request()->is(['sispilu/monitoring_parpol']) ? 'show' : '' }}" href="#" >
                    <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/home -->
