                    ...
                    <div class="col-12 col-md-9 d-flex flex-column">
                      <div class="card-body">
                        ...
                        <div class="row align-items-center">
                          ...
                          <div class="col-auto">
                              <input type="file" name="foto_caleg" class="form-control">
                          </div>
                        </div>
                        ...
                        <div class="row g-3">
                          <div class="col-md">
                            ...
                            <input type="text" class="form-control" name="nama_caleg" value="{{ $setting->nama_caleg }}">
                          </div>
                          <div class="col-md">
                        ...
                        <h3 class="card-title mt-4">NIK</h3>
                        <div>
                          <div class="row g-2">
                            <div class="col-auto">
                              <input type="number" class="form-control w-auto" name="nik" value="{{ $setting->nik }}">
                            </div>
                          </div>
                        </div>
