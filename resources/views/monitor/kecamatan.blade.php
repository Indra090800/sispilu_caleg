...
<div class="page-body">
    <div class="container-xl">
        ...
        <div class="row mt-2">
            <div class="col-12">
                <form action="/monitor/kordinator/kecamatan" method="GET">
                    <div class="row">
                        <div class="col-4">
                            <div class="form-group">
                                <select name="desa" id="desa" class="form-control">
                                    <option value="">{{ Request('desa') == null ? 'Pilih Kelurahan' : Request('desa')  }}</option>
                        ...
                        <div class="col-4">
                            <div class="form-group">
                                <select name="desa1" id="desa1" class="form-control">
                                    <option value="">{{ Request('desa1') == null ? 'Pilih Kelurahan' : Request('desa1')  }}</option>
                                    @foreach ($Otps as $val)
                                        <option value="{{ $val->desa }}">{{ $val->desa }}</option>
                                    @endforeach
                                </select>
