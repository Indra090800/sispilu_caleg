...
<div class="page-body">
    <div class="container-xl">
        ...
        <div class="row mt-2">
            <div class="col-12">
            @if(Auth::guard()->user()->id_role == 2 || Auth::guard()->user()->id_role == 6)
        ...
        <div class="row mt-2">
            <div class="col-12">
                <form action="/monitor/kordinator/kelurahan/voters" method="GET">
                    <div class="row">
                        <div class="col-4">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <form action="/voters/{{ $k->id_voters }}/delete" method="POST" style="margin-left: 5px;">
                                            ...
                                            <a href="#" class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#editvoters{{ $k->id_voters }}">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="input-icon mb-3">
                            ...
                            <input type="text" name="desa" id="desa" value="{{ Auth::guard()->user()->wilayah }}" readonly class="form-control" placeholder="Nama Desa">
                        </div>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="input-icon mb-3">
                            ...
                            <input type="text" value="{{ $k->desa }}" readonly name="desa" id="desa" class="form-control" placeholder="Nama Desa">
                        </div>
                    </div>
                </div>
                <div class="row">
