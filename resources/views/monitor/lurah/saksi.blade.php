        ...
        <div class="page-body">
            <div class="container-xl">
                ...
                <div class="row mt-2">
                    <div class="col-12">
                        <form action="/monitor/kordinator/kelurahan/saksi" method="GET">
                            <div class="row">
                                <div class="col-6">
        ...
        <div class="modal modal-blur fade" id="modal-inputsaksi" tabindex="-1" role="dialog" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="/addSaksi1" method="post" id="frmSaksi" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-12">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="input-icon mb-3">
                                    ...
                                    <input type="text" name="desa" id="desa" value="{{ Auth::guard()->user()->wilayah }}" class="form-control" placeholder="Desa" readonly>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="input-icon mb-3">
                                    ...
                                    <input type="text" readonly value="{{ $k->desa}}" name="desa" id="desa" class="form-control" placeholder="Desa">
                                </div>
                            </div>
                        </div>
